      ...
      <div className="inner">
        <div className="row">
          <div className="col-12">
            <h2>
              Our <span className="sky-fill">Pricing</span>
            </h2>
          </div>
          <div className="col-sm-12 col-md-12 col-lg-5 col-xl-5">
            <div className="pricing-box card">
              <div className="box-inner">
                <h4>
                  <span className="sky-fill">Cheapest</span> prices on the Market !
                </h4>
                <h3>0.002$</h3>
          ...
          <div className="col-sm-12 col-md-12 col-lg-7 col-xl-7">
            <div className="pricing-card card">
              ...
              <p>
                ...
                <span className="sky-fill" >
                  crypto payments
                </span>{" "}
                toward our service are made easy,
